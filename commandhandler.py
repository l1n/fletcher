    ...
    async def command_handler(self, message):
        ...
        try:
            ...
            if type(message.channel) is discord.TextChannel:
                ...
                pass
            pass
        if messagefuncs.extract_identifiers_messagelink.search(message.content) or messagefunc.extract_previewable_link.search(message.content) and not (message.content.startswith("!preview") or message.content.startswith("!blockquote")):
